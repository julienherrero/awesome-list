...
- [Wavesonics/ComposeTextEditorLibrary](https://github.com/Wavesonics/ComposeTextEditorLibrary) - Compose's missing Rich Text editor
...
- [iamjosephmj/flinger](https://github.com/iamjosephmj/flinger) - Customizable Fling Physics for Jetpack Compose. Take full control of scroll momentum in LazyColumn, LazyRow, Pagers, and more with 9+ presets, snap behavior, and adaptive physics.
...
- [infinum/Retromock](https://github.com/infinum/Retromock) - Library for mocking responses in a Retrofit service.
...
- [klyx-dev/klyx](https://github.com/klyx-dev/klyx) - Klyx is a lightweight, high-performance code editor for Android.
...
- [muchaisam/BaoBuzz](https://github.com/muchaisam/BaoBuzz) - Modern Android live score application showcasing Jetpack Compose, glassmorphism design system, and MVVM architecture. Features include real-time match data, interactive quiz, historical facts, and season comparisons. Built with Kotlin, Hilt DI, Room, Coroutines. 30-50% fewer recompositions.
...
- [prof18/RSS-Parser](https://github.com/prof18/RSS-Parser) - Kotlin Multiplatform library for parsing RSS, Atom, and RDF feeds on Android, iOS, macOS, tvOS, watchOS, JVM, JS, and Wasm.
...
- [ryanw-mobile/OctoMeter](https://github.com/ryanw-mobile/OctoMeter) - [maintenance mode] Kotlin Multiplatform Desktop/Android/iOS Energy Tracker app
...
- [saket/byte-size](https://github.com/saket/byte-size) - Kotlin multiplatform units for representing SI and IEC bytes and bits, inspired by jakewharton/byteunits and kotlin.time.Duration
...
- [sami-eljabali/java-time-fun](https://github.com/sami-eljabali/java-time-fun) - java.time Kotlin extension functions library.
...
- [skydoves/landscapist](https://github.com/skydoves/landscapist) - 🌻 A pluggable, highly optimized Jetpack Compose and Kotlin Multiplatform image loading library that fetches and displays network images, compatible with Glide, Coil, and Fresco.
